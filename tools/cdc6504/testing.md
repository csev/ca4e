# CDC6504 Tool Testing Plan

## Overview
This document outlines comprehensive testing procedures for the CDC6504 CPU Emulator tool, including UI validation, error detection, assignment functionality, and ASCII chart testing.
...
3. Note: CDC6504 tool does not have easter eggs, so testing focuses on manual programming
...
1. **Setup**
   ...
   - Verify instructions: "Write a CDC6504 program that outputs 'Hello, World!' or 'Hello World!'."
   - Start grading process

2. **Manual Programming**
   - Write CDC6504 assembly program to output "Hello, World!"
...
1. **Setup**
   ...
   - Open assignment modal
   - Verify instructions: "Write a CDC6504 program that outputs the number 42."
   - Start grading process

2. **Manual Programming**
   - Write CDC6504 assembly program to output "42"
   - Use proper instruction set:
     - SET instructions for immediate values
...
**Purpose**: Verify the CDC6504 CPU emulator functions correctly.
