...
<head>
    ...
    <title>CDC6504 Emulator Integration</title>
    <style>
        body {
...
<?php endif; ?>
    ...
    <script type="module" src="./wc/cdc6504-cpu.js"></script>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setTimeout(() => {
                ...
                const emulator = new CDC6504Emulator(cpuComponent);
...
BRK`;
                ...
                document.getElementById('storageDropdown').addEventListener('change', (e) => {
                    ...
                    if (action === 'save') {
                        ...
                        if (assemblyCode.trim()) {
                            ...
                            if (programName) {
                                const savedPrograms = JSON.parse(localStorage.getItem('cdc6504_programs') || '{}');
                                savedPrograms[programName] = {
                                    code: assemblyCode,
                                    timestamp: new Date().toISOString()
                                };
                                localStorage.setItem('cdc6504_programs', JSON.stringify(savedPrograms));
                ...
                console.log('CDC6504 Emulator Integration Ready!');
