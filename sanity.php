...
/**
 * Installation sanity checks for the CA4E home page only.
 */

function ca4e_sanity_die($title, $body_html) {
    error_log('CA4E sanity: '.$title);
...
if ( ! is_dir($tsugi_dir) ) {
    ca4e_sanity_die(
        ...
        '<p>This copy of Computer Architecture for Everybody expects a <code>tsugi</code> folder next to
        <code>index.php</code>, but that folder was not found.</p>
        <p>From your <code>ca4e</code> directory, check out Tsugi:</p>
        <pre>cd ca4e
git clone https://github.com/tsugiproject/tsugi.git tsugi</pre>
        ...
        <p>More detail: <a href="https://github.com/csev/ca4e/blob/master/README.md"
        target="_blank" rel="noopener noreferrer">CA4E README</a></p>'
    );
}
...
if ( count($missing) > 0 ) {
    ca4e_sanity_die(
        ...
        <p>From your <code>ca4e</code> directory, refresh the Tsugi checkout:</p>
        <pre>cd ca4e/tsugi
git pull
